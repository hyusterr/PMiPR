...
class FileGraph {
    ...
    private:
        ...
        // load from files
        void load_from_edge_list(std::string path, std::vector<char*>& index2node, int undirected);
        void load_from_reverse_edge_list(std::string path, std::vector<char*>& index2node);
